...
Dit is hét structuurverschil met Nederland en België: in Frankrijk koopt u met uw abonnement een vermogensplafond, in trappen (kVA). De gangbare trappen voor woningen zijn 3–6–9–12 kVA monophasé en 9 kVA en hoger triphasé; de exacte actuele reeksen en de vraag of alle trappen nog voor nieuwe contracten beschikbaar zijn: [NIET GEVERIFIEERD — Enedis-reeksen actualiseren vóór publicatie]. Hetzelfde geldt voor twee claims uit de forumdiscussies die het beleid raken: dat er voor nieuwe aansluitingen geen monophasé boven 12 kVA meer wordt geleverd (Rob, 2020, o.v.v. een Enedis-document) en dat de Base-tariefoptie per 01-02-2025 voor ≥ 9 kVA zou zijn afgeschaft — beide [NIET GEVERIFIEERD — vóór publicatie beslechten; zie reviewpakket].
...
- **Netcapaciteit.** Enedis hoeft een ombouwverzoek niet te honoreren: monophasé vergt dikkere aanvoer, en op dun bekabelde plattelandsnetten kan de spanningsval dan buiten de wettelijke band lopen (230 V-band en 400 V-band met vaste toleranties; exacte grenswaarden [NIET GEVERIFIEERD — Enedis-referentie toevoegen]).
- **Kosten.** Bij ombouw kan een nieuwe kabel vanaf het net nodig zijn, zeker bij een type 2-aansluiting; die kosten zijn voor de eigenaar. De actuele bedragen staan in de Enedis *Catalogue des Prestations* [NIET GEVERIFIEERD — tarieven opzoeken vóór publicatie].
...
- Nog open op verificatie: afschaffing Base-optie ≥ 9 kVA per 01-02-2025 (één bron) en de actuele kVA-reeksen — zie reviewpakket.
